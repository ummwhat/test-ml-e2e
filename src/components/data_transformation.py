...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            cat_pipeline = Pipeline(steps = [("imputer", SimpleImputer(strategy='most_frequent')),("ohe",OneHotEncoder()),("scaler", StandardScaler(with_mean=False))])
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            logging.info("Obtaining data transformer now")
            ...
            logging.info("Applying the preprocessor on training and testing datasets")
